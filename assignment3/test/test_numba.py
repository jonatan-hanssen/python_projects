...
def test_color2gray(image, reference_gray):
    # ------------ test with reference ----------------
    actual_gray = numba_color2gray(image)
    ...
    actual_gray_premade = numba_color2gray(premade_gray)
...
def test_color2sepia(image, reference_sepia):
    # ------------ test with reference ----------------
    actual_sepia = numba_color2sepia(image)
    ...
    actual_sepia_premade = numba_color2sepia(premade_image)
